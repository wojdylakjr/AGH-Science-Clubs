...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALENDAREVENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALENDAREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALENDAREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALENDAREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALENDAREVENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALENDAREVENT actions', async () => {
      const expectedActions = [
        {
